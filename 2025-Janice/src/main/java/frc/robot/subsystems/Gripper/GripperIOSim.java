...
public class GripperIOSim implements GripperIO {
    ...
    private static final DCMotor gripperMotorModel = DCMotor.getKrakenX60(1);

    private final DCMotorSim gripperMotor =
      new DCMotorSim(
         LinearSystemId.createDCMotorSystem(gripperMotorModel, 0.025, IntakeConstants.kIndexerGearRatio),
         gripperMotorModel);
