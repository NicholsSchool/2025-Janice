  ...
  public ModuleIOTalonFX(int index) {
    switch (index) {
      case 0: // front left
        ...
        absoluteEncoderOffset = new Rotation2d(Math.toRadians(90)); // MUST BE CALIBRATED
        break;
      case 1: // front right
        turnGearRatio = kTURN_GEAR_RATIO_FRONT;
        ...
        absoluteEncoderOffset = new Rotation2d(Math.toRadians(165)); // MUST BE CALIBRATED
        break;
      case 2: // back left
        ...
        absoluteEncoderOffset = new Rotation2d(Math.toRadians(-35)); // MUST BE CALIBRATED
        break;
      case 3: // back right
        turnGearRatio = kTURN_GEAR_RATIO_REAR;
        ...
        absoluteEncoderOffset = new Rotation2d(Math.toRadians(85  )); // MUST BE CALIBRATED
        break;
      default:
